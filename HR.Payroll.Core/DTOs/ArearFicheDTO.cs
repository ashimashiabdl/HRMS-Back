...
{
    public class ArearFicheDTO : BaseDTO
    {
        public long? ArearId { get; set; }
        public long EmployeeId { get; set; }
        /// <summary>
        /// تعداد اقلام تغییر یافته نسبت به فیش عادی
        /// </summary>
        public int ChangedItemsCount { get; set; }
        /// <summary>
        /// جمع تفاوت اقلام (معوقه − عادی)
        /// </summary>
        public long ChangedItemsDifferenceSum { get; set; }
        [StringLength(100)]
        ...
        public List<ArearFicheItemDTO>? DeductionFicheItems { set; get; }
        public List<ArearFicheItemDTO>? PaymentFicheItems { set; get; }
