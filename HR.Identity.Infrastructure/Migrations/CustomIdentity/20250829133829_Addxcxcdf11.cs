...
{
    /// <inheritdoc />
    public partial class Addxcxcdf11 : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_User_Report_AspNetUsers_UserId",
                        column: x => x.UserId,
                    ...
                    table.ForeignKey(
                        name: "FK_User_Report_Organisation_Chart_OrganisationChartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_Report_OrganisationChartId",
                schema: "Identity",
                table: "User_Report",
