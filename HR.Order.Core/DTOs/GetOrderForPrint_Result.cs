...
{
    public class GetOrderForPrint_Result
    {
        ...
        public Nullable<int> SummaryJobDegree { get; set; }
        ...
        public Nullable<bool> IsIsar1 { get; set; }
        public Nullable<float> IsarPercent1 { get; set; }
        public string OtherVeterans1 { get; set; }
        public Nullable<System.DateTime> CreateDate { get; set; }
        public string InterdictCreateDateShamsi { get; set; }
        ...
        public string BirthPlaceType { get; set; }
        ...
        public string IssuePlaceType { get; set; }
        public string PositionCode { get; set; }
        public string Position { get; set; }
        public string EntOrgChartJobCategoryName { get; set; }
        ...
        public string OrganPropertyAddress { get; set; }
        public Nullable<System.Guid> UniqueId { get; set; }
        public Nullable<long> ServicePlaceId { get; set; }
