...
public class LeaveTypeController : AppBaseController
{
    ...
    public LeaveTypeController(LeaveTypeService service, ILogger<LeaveTypeController> logger, IHttpContextAccessor accessor, IMapper mapper, IDapper dapper, UserResolverService UserResolverService) : base(UserResolverService, logger, accessor, mapper, dapper)
    {
        _service = service;
    ...
    public async Task<IActionResult> Post([FromBody] LeaveTypeDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] LeaveTypeDTO body)
    {
        if (ModelState.IsValid)
        {
            try
