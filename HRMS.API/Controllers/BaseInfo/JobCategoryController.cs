...
public class JobCategoryController(JobCategoryService JobCategoryService, ILogger<JobCategoryController> logger, IHttpContextAccessor accessor, IMapper mapper, IDapper dapper, UserResolverService UserResolverService) : AppBaseController(UserResolverService, logger, accessor, mapper, dapper)
{
    private readonly JobCategoryService _baseTableService = JobCategoryService;
    ...
    public async Task<IActionResult> Post([FromBody] JobCategoryDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] JobCategoryDTO body)
    {
        if (ModelState.IsValid)
        {
            try
