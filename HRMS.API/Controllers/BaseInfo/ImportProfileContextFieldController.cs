...
[Route("api/ImportProfileContextField")]
[ControllerGroup("baseInfo", "اطلاعات پایه ")]
[DisplayName("فیلد Context پروفایل Import")]
public class ImportProfileContextFieldController : AppBaseController
{
    private readonly ImportProfileContextFieldCrudService _service;

    public ImportProfileContextFieldController(
        ImportProfileContextFieldCrudService service,
        ILogger<ImportProfileContextFieldController> logger,
    ...
    public async Task<IActionResult> Post([FromBody] ImportProfileContextFieldCrudDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] ImportProfileContextFieldCrudDTO body)
    {
