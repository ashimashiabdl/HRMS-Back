...
[Route("api/SettlementDocumentAttachmentType")]
[ControllerGroup("baseInfo", "اطلاعات پایه ")]
[DisplayName("نوع پیوست سند تسویه حساب")]
public class SettlementDocumentAttachmentTypeController : AppBaseController
{
    private readonly SettlementDocumentAttachmentTypeService _service;

    public SettlementDocumentAttachmentTypeController(SettlementDocumentAttachmentTypeService service, ILogger<SettlementDocumentAttachmentTypeController> logger, IHttpContextAccessor accessor, IMapper mapper, IDapper dapper, UserResolverService UserResolverService) : base(UserResolverService, logger, accessor, mapper, dapper)
    {
        _service = service;
    ...
    public async Task<IActionResult> Post([FromBody] SettlementDocumentAttachmentTypeDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] SettlementDocumentAttachmentTypeDTO body)
    {
