...
[Route("api/AttendanceHoliday")]
[ControllerGroup("baseInfo", "اطلاعات پایه ")]
[DisplayName("تعطیلات حضور و غیاب")]
public class AttendanceHolidayController : AppBaseController
{
    private readonly AttendanceHolidayService _service;

    public AttendanceHolidayController(
        AttendanceHolidayService service,
        ILogger<AttendanceHolidayController> logger,
    ...
    public async Task<IActionResult> Post([FromBody] AttendanceHolidayDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] AttendanceHolidayDTO body)
    {
