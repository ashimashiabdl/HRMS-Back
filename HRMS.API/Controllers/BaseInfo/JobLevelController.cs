...
[DisplayName("سطح شغل")]
public class JobLevelController : AppBaseController
{
    private readonly JobLevelService _service;
    public JobLevelController(JobLevelService service, ILogger<JobLevelController> logger, IHttpContextAccessor accessor, IMapper mapper, IDapper dapper, UserResolverService UserResolverService) : base(UserResolverService, logger, accessor, mapper, dapper)
    {
        _service = service;
    ...
    public async Task<IActionResult> Post([FromBody] JobLevelDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] JobLevelDTO body)
    {
