...
public class MeasurementUnitController : AppBaseController
{
    private readonly MeasurementUnitService _service;

    public MeasurementUnitController(MeasurementUnitService service, ILogger<MeasurementUnitController> logger, IHttpContextAccessor accessor, IMapper mapper, IDapper dapper, UserResolverService UserResolverService) : base(UserResolverService, logger, accessor, mapper, dapper)
    {
        _service = service;
    ...
    public async Task<IActionResult> Post([FromBody] MeasurementUnitDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] MeasurementUnitDTO body)
    {
