...
[Route("api/OrganisationSettlementItem")]
[ControllerGroup("SystemSetting", "تنظیمات سیستم")]
[DisplayName("آیتم تسویه حساب سازمان")]
public class OrganisationSettlementItemController : AppBaseController
{
    private readonly OrganisationSettlementItemService _service;

    public OrganisationSettlementItemController(
        OrganisationSettlementItemService service,
        ILogger<OrganisationSettlementItemController> logger,
    ...
    public async Task<IActionResult> Post([FromBody] OrganisationSettlementItemDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] OrganisationSettlementItemDTO body)
    {
