...
[Route("api/EmployeeShiftAssignment")]
[ControllerGroup("Attendance", "حضور و غیاب")]
[DisplayName("تخصیص شیفت کارمند")]
public class EmployeeShiftAssignmentController : AppBaseController
{
    private readonly EmployeeShiftAssignmentService _service;

    public EmployeeShiftAssignmentController(
        EmployeeShiftAssignmentService service,
        ILogger<EmployeeShiftAssignmentController> logger,
    ...
    public async Task<IActionResult> Post([FromBody] EmployeeShiftAssignmentDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] EmployeeShiftAssignmentDTO body)
    {
