...
[Route("api/AttendanceCalendar")]
[ControllerGroup("Attendance", "حضور و غیاب")]
[DisplayName("تقویم حضور و غیاب")]
public class AttendanceCalendarController : AppBaseController
{
    private readonly AttendanceCalendarService _service;

    public AttendanceCalendarController(
        AttendanceCalendarService service,
        ILogger<AttendanceCalendarController> logger,
    ...
    public async Task<IActionResult> Post([FromBody] AttendanceCalendarDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] AttendanceCalendarDTO body)
    {
