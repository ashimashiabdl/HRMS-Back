...
[DisplayName("لاگ تردد")]
public class AttendanceLogController : AppBaseController
{
    private readonly AttendanceLogService _service;

    public AttendanceLogController(
        AttendanceLogService service,
        ILogger<AttendanceLogController> logger,
    ...
    public async Task<IActionResult> Post([FromBody] AttendanceLogDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] AttendanceLogDTO body)
    {
