...
[Route("api/EmployeeAttendanceDailyResult")]
[ControllerGroup("Attendance", "حضور و غیاب")]
[DisplayName("نتیجه روزانه حضور کارمند")]
public class EmployeeAttendanceDailyResultController : AppBaseController
{
    private readonly EmployeeAttendanceDailyResultService _service;

    public EmployeeAttendanceDailyResultController(
        EmployeeAttendanceDailyResultService service,
        ILogger<EmployeeAttendanceDailyResultController> logger,
    ...
    public async Task<IActionResult> Post([FromBody] EmployeeAttendanceDailyResultDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] EmployeeAttendanceDailyResultDTO body)
    {
