...
[Route("api/AttendanceLocation")]
[ControllerGroup("Attendance", "حضور و غیاب")]
[DisplayName("محل حضور")]
public class AttendanceLocationController : AppBaseController
{
    private readonly AttendanceLocationService _service;

    public AttendanceLocationController(
        AttendanceLocationService service,
        ILogger<AttendanceLocationController> logger,
    ...
    public async Task<IActionResult> Post([FromBody] AttendanceLocationDTO body)
    {
    ...
    public async Task<IActionResult> Put([FromBody] AttendanceLocationDTO body)
    {
