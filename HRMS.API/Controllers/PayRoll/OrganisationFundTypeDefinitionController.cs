...
[Route("api/OrganisationFundTypeDefinition")]
[ControllerGroup("PayRoll", "حقوق و دستمزد")]
[DisplayName("تعریف نوع صندوق سازمان")]
public class OrganisationFundTypeDefinitionController : AppBaseController
{
    private readonly OrganisationFundTypeDefinitionService _service;
    public OrganisationFundTypeDefinitionController(OrganisationFundTypeDefinitionService service, ILogger<OrganisationFundTypeDefinitionController> logger, IHttpContextAccessor accessor, IMapper mapper, IDapper dapper, UserResolverService UserResolverService) : base(UserResolverService, logger, accessor, mapper, dapper)
    {
        _service = service;
    ...
    public async Task<IActionResult> Post([FromBody] OrganisationFundTypeDefinitionDTO body)
    {
        body.title = "-";
    ...
    public async Task<IActionResult> Put([FromBody] OrganisationFundTypeDefinitionDTO body)
    {
        body.title = "";
