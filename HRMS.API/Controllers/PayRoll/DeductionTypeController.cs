...
[Route("api/DeductionType")]
[ControllerGroup("PayRoll", "حقوق و دستمزد")]
[DisplayName("نوع کسور")]
public class DeductionTypeController : AppBaseController
{
    private readonly DeductionTypeService _service;
    public DeductionTypeController(DeductionTypeService Service, ILogger<DeductionTypeController> logger, IHttpContextAccessor accessor, IMapper mapper, IDapper dapper, UserResolverService UserResolverService) : base(UserResolverService, logger, accessor, mapper, dapper)
    {
        _service = Service;
    ...
    [HttpPost("Post")]
    public async Task<IActionResult> Post([FromBody] DeductionTypeDTO body)
    {
    ...
    [HttpPut("Put")]
    public async Task<IActionResult> Put([FromBody] DeductionTypeDTO body)
    {
