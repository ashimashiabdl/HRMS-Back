...
namespace HR.SharedKernel.OLD
{
    public static class ConvertToIranSystem
    {
        ...
        #region _charMapperCharIsNotFinal
          ...
          new Dictionary<byte, byte>
      {
        ...
        #region _charMapperNextCharFinal
          ...
          new Dictionary<byte, byte>
      {
        ...
        #region _charMapperPreviousCharFinal
           ...
           new Dictionary<byte, byte>
       {
        ...
        #region _charMapperPreviousCharNextCharFinal
        ...
        private static List<byte> getUnicodeToIranSystem(string text, IranSystemNumbers iranSystemNumbers)
        {
            ...
            for (var i = 0; i < length; i++)
            {
                ...
                else if (i != 0 && i != length - 1)
                {
                    ...
                    if (cur == AlefChasban) // براي بررسي استثناي لا
                    {
                        if (pre == LaamAvval)
                        {
