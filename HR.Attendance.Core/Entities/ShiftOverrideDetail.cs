...
[Table("Attendance_Shift_Override_Detail", Schema = "Attendance")]
public class ShiftOverrideDetail : BaseEntity, IignoreDateRangeValidation
{
    [ForeignKey("ShiftOverride")]
    public long ShiftOverrideId { get; set; }
    public virtual ShiftOverride? ShiftOverride { get; set; }
