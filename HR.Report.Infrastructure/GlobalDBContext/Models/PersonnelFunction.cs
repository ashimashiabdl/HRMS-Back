...
[Microsoft.EntityFrameworkCore.Index("EmployeeId", "Year", "Month", Name = "IX_Personnel_Function_EmployeeId_Year_Month_Id")]
public partial class PersonnelFunction
{
    [Key]
    ...
    [InverseProperty("PersonnelFunction")]
